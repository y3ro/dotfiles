...
-- TODO: diagnostic keybindings with d
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>ls', require('telescope.builtin').lsp_document_symbols, '[W]orkspace [S]ymbols')
